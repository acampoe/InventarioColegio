...
public class Entrada extends javax.swing.JDialog {
     ...
     */
    public Entrada(java.awt.Frame parent, boolean modal, String db, String userID) {
        super(parent, modal);
        initComponents();
        this.Database = db;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Entrada dialog = new Entrada(new javax.swing.JFrame(), true, new String(), new String());
